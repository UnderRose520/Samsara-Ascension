...
const ENEMY_HP := 95.0
const ENEMY_BOSS_HP := 520.0
const MAX_ROOM_ENEMIES := 14
const ENEMY_MOVE_SPEED := 112.0
const ENEMY_BOSS_MOVE_SPEED := 92.0
...
const ENEMY_ORBIT_RADIUS_BOSS := 96.0
...
const COMBO_MILESTONES := [10, 30, 60, 100, 200]
