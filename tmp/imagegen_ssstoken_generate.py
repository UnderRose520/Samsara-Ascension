...
JOBS = [
    {
        "prompt_file": Path("output/imagegen/samsara_jade_cultivator_hd_image2_prompt.txt"),
        "out_file": Path("output/imagegen/batch_hd/samsara_jade_cultivator_hd_image2.png"),
    },
    {
        "prompt_file": Path("output/imagegen/samsara_thunder_demon_general_hd_image2_prompt.txt"),
        "out_file": Path("output/imagegen/batch_hd/samsara_thunder_demon_general_hd_image2.png"),
    },
]
