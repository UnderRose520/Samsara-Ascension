...
JOBS = [
    {
        "prompt_file": Path("output/imagegen/samsara_jade_cultivator_hd_chibi_prompt.txt"),
        "out_file": Path("output/imagegen/batch_hd/samsara_jade_cultivator_hd_chibi.png"),
    },
    {
        "prompt_file": Path("output/imagegen/samsara_thunder_elite_chibi_prompt.txt"),
        "out_file": Path("output/imagegen/batch_hd/samsara_thunder_elite_chibi.png"),
    },
]
