...
JOBS = [
    {
        "prompt_file": Path("output/imagegen/samsara_enemy_melee_chibi_prompt.txt"),
        "out_file": Path("output/imagegen/batch_hd/samsara_enemy_melee_chibi.png"),
    },
    {
        "prompt_file": Path("output/imagegen/samsara_enemy_ranged_chibi_prompt.txt"),
        "out_file": Path("output/imagegen/batch_hd/samsara_enemy_ranged_chibi.png"),
    },
]
