...
JOBS = [
    {
        "prompt_file": Path("output/imagegen/samsara_enemy_melee_normal_prompt.txt"),
        "out_file": Path("output/imagegen/batch_hd/samsara_enemy_melee_normal.png"),
    },
    {
        "prompt_file": Path("output/imagegen/samsara_enemy_ranged_normal_prompt.txt"),
        "out_file": Path("output/imagegen/batch_hd/samsara_enemy_ranged_normal.png"),
    },
]
